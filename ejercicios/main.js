...
fetch(url)//solicitud a la url
    ...
    .then(data => mostrarData(data))// se lee este objeto data y se muestran los datos recibidos
    .catch(error => console.log(error)) //si hay un error sera atrapado por la plabra catch
